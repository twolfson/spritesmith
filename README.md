...
We have moved to `binary-tree` as the default `algorithm`. We wanted to give the best possible packing out of the box. If you were using `top-down` as the default, please specify it in your configuration.
